...
/// 时间：2008-10-12
/// </summary>
public partial class FlowerShopList : System.Web.UI.Page
{
    //设置每页显示条目数
    ...
    private void BindData()
    {
        ...
        //数据绑定到DataListFlowerShops控件
        DataListFlowerShops.DataSource = FlowerShopManage.GetAllFlowerShop(pageSize,currentPage,"");

        DataListFlowerShops.DataBind();

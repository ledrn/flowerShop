...
/// 时间：2008-10-07
/// </summary>
public partial class LeagueQA : System.Web.UI.Page
{
    //设置每页显示条目数
    ...
    private void BindData()
    {
        ...
        //数据绑定到DataListLeagueQA控件
        DataListLeagueQA.DataSource = QuestionAnswerManage.GetAllQuestionAnswer(pageSize, currentPage, "加盟常见问题","");
        DataListLeagueQA.DataBind();

<%@ Page Title="网站后台-加盟常见问题列表" Language="C#" MasterPageFile="~/Admin/AdminPage.master" AutoEventWireup="true" CodeFile="LeagueQAList.aspx.cs" Inherits="Admin_LeagueQAList" %>
    ...
    <div>
        <asp:GridView ID="gdvData" runat="server" BorderStyle="None" BorderWidth="1px" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Question" HeaderText="问题描述" />
                    <asp:TemplateField>
                        <ItemTemplate>

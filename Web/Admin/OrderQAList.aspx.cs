...
/// 时间：2008-09-27
/// </summary>
public partial class Admin_OrderQAList : System.Web.UI.Page
{
    //设置每页显示条目数
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //获取总记录数
            recCount = QuestionAnswerManage.GetAllQuestionAnswerNum("订单常见问题", "");
            //初始状态下，将条件置为空
            ViewState["Query"] = "";
            //参数初始化
            InitParameter();
    ...
    private void BindData()
    {
        ...
        //数据绑定到GridView控件
        gdvData.DataSource = QuestionAnswerManage.GetAllQuestionAnswer(pageSize, currentPage, "订单常见问题", whereByTitle);
        gdvData.DataBind();
    ...
    protected void gdvData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            ((Button)(e.Row.Cells[3].FindControl("btnEdit"))).PostBackUrl = "EditOrderQA.aspx?qaId=" + e.Row.Cells[0].Text;
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        //获取总记录数
        recCount = QuestionAnswerManage.GetAllQuestionAnswerNum("订单常见问题", txtQuestion.Text.Trim());

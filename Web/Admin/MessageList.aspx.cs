...
public partial class Admin_MessageList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //获取总记录数
            recCount = MessageManage.GetAllMessageNum("admin", "");
    ...
    private void BindData()
    {
        ...
        //数据绑定到GridView控件
        gdvData.DataSource = MessageManage.GetAllMessage(pageSize, currentPage,"admin", whereByTitle);
        gdvData.DataBind();
    ...
    protected void gdvData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            ((Button)(e.Row.Cells[6].FindControl("btnEdit"))).PostBackUrl = "EditMessage.aspx?messageId=" + e.Row.Cells[0].Text;
        }
        ...
        {
            case "1":
                e.Row.Cells[3].Text = "未阅";
                break;
            case "0":
                e.Row.Cells[3].Text = "已阅";
                break;
            case "-1":
    ...
    protected void gdvData_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        message.ID = Convert.ToInt32(gdvData.DataKeys[e.RowIndex].Value);
    ...
    {
        ViewState["Query"] = txtFromUser.Text.Trim();
        //获取总记录数
        recCount = MessageManage.GetAllMessageNum("admin",txtFromUser.Text.Trim());
        //参数初始化
        InitParameter();
        //数据绑定
        this.BindData();

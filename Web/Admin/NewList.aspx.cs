...
/// 时间：2008-09-26
/// </summary>
public partial class Admin_NewList : System.Web.UI.Page
{
    //设置每页显示条目数
    ...
    private void BindData()
    {
        ...
        //数据绑定到GridView控件
        gdvData.DataSource = NewManage.GetAllNews(pageSize, currentPage, whereByTitle);
        gdvData.DataBind();
    ...
    protected void gdvData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            ((Button)(e.Row.Cells[4].FindControl("btnEdit"))).PostBackUrl = "EditNew.aspx?newId=" + e.Row.Cells[0].Text;
        }
    }
    ...
    protected void gdvData_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        newInfo.ID = Convert.ToInt32(gdvData.DataKeys[e.RowIndex].Value);

        NewManage.DeleteNew(newInfo);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        //获取总记录数
        recCount = NewManage.GetAllNewsNum(txtNewTitle.Text.Trim());
        //参数初始化
        InitParameter();
        //数据绑定
        this.BindData();

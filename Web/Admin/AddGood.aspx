<%@ Page Title="网站后台-添加商品" Language="C#" MasterPageFile="~/Admin/AdminPage.master" AutoEventWireup="true" CodeFile="AddGood.aspx.cs" Inherits="Admin_AddGood" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style=" width:430px; text-align:left; line-height:24px;">
      ...
      <div style=" text-align:center">  <asp:RadioButtonList ID="rblSpecial" runat="server" RepeatColumns="3">
      ...
      <p>  商品名称：&nbsp;&nbsp;<asp:TextBox ID="txtName" runat="server"  CssClass="admintextbox" 
            Width="300px"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidatorName" runat="server" 
            ErrorMessage="RequiredFieldValidator" Text="*" ControlToValidate="txtName"></asp:RequiredFieldValidator>
        <br />
        商品组成：&nbsp;&nbsp;<asp:TextBox ID="txtComponent" runat="server"  CssClass="admintextbox" 
            Width="300px"></asp:TextBox><br />
        包装：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtPackage" runat="server"  CssClass="admintextbox" 
            Width="300px"></asp:TextBox><br />
        描述(花语)：<asp:TextBox ID="txtDescribe" runat="server" Height="80px" 
            TextMode="MultiLine" Width="300px"  CssClass="admintextbox"></asp:TextBox><br />
        配送范围：&nbsp;&nbsp;<asp:TextBox ID="txtSendRange" runat="server"  CssClass="admintextbox" 
            Width="300px"></asp:TextBox><br />
        价格：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtPrice" runat="server"  CssClass="admintextbox" 
